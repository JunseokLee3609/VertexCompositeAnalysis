...
class PATCompositeTreeProducer4 : public edm::one::EDAnalyzer<> {
public:
  explicit PATCompositeTreeProducer4(const edm::ParameterSet&);
  ~PATCompositeTreeProducer4();
...
bool PATCompositeTreeProducer4::matchHadron(const reco::Candidate* _dmeson_, const reco::GenParticle& _gen_, bool isMatchD0) const {
  bool match = false;
  if(isMatchD0){
...
bool PATCompositeTreeProducer4::matchHadron(const reco::Candidate* _dmeson_, const reco::Candidate& _gen_, bool isMatchD0) const {
  bool match = false;
  if(isMatchD0){
    reco::Candidate const* reco_trk1 = _dmeson_->daughter(0);
    reco::Candidate const* reco_trk2 = _dmeson_->daughter(1);
...
bool PATCompositeTreeProducer4::checkSwap(const reco::Candidate* _dmeson_, const reco::GenParticle& _gen_) const {
    return _dmeson_->pdgId() != _gen_.pdgId();
};
bool PATCompositeTreeProducer4::checkSwap(const reco::Candidate* _dmeson_, const reco::Candidate& _gen_) const {
    return _dmeson_->pdgId() != _gen_.pdgId();
};

bool PATCompositeTreeProducer4::matchTrackdR(const reco::Candidate* _recoTrk_, const reco::Candidate* _genTrk_, bool chkchrg) const {
    bool pass= false;
    // _deltaR_
...
reco::GenParticleRef PATCompositeTreeProducer4::findMother(const reco::GenParticleRef& genParRef)
{
...
void PATCompositeTreeProducer4::genDecayLength(const reco::Candidate& gCand, float& gen_decayLength2D_, float& gen_decayLength3D_, float& gen_angle2D_, float& gen_angle3D_){
...
//void PATCompositeTreeProducer4::getAncestorId(const reco::Candidate& gCand, int& gen_ancestorId_, int& gen_ancestorFlavor_ ){
//  gen_ancestorId_ = 0;
