...
// perform MVA evaluation
  ...
  // GBR METHOD END
          ...
          onnxVals_[6] = d0Angle2D;
          onnxVals_[7] = lVtxMag;
          onnxVals_[8] = lVtxMag / sigmaLvtxMag;
          onnxVals_[9] = rVtxMag;
          onnxVals_[10] = rVtxMag / sigmaRvtxMag;
          onnxVals_[11] = posCandTotalP.perp();
          onnxVals_[12] = posCandTotalP.eta();
          onnxVals_[13] = negCandTotalP.perp();
          onnxVals_[14] = negCandTotalP.eta();
          onnxVals_[15] = ptErr_pos;
          onnxVals_[16] = ptErr_neg;
          onnxVals_[17] = dca;
