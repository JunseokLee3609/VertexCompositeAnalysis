...
config.General.requestName = "D0Ana_Data_Step1_HIPhysicsRawPrime0_wOffCentTable_10MTraining_CMSSW_13_2_13_MVA_29Dec25_v1"
...
config.JobType.psetName = "../../production/pbpb2023/data/PbPb2023_D0BothAndDStar_MB_cfg_v1_Step1.py"
config.JobType.numCores = 1
config.JobType.maxMemoryMB = 3000         # request high memory machines.
# config.JobType.inputFiles=['../../conditions/centrality/CentralityTable_HFtowers200_DataPbPb_periHYDJETshape_run3v1302x04_offline_Nominal.db']
