...
config.General.requestName = "DStarDeltaMassHistD0SSRawKin_Data_HIPhysicsRawPrime0_8_Fiducial_MVACutM1_14May26_v1"
...
config.JobType.psetName = "../../validation/dstar_mass/PbPb2023_D0BothAndDStar_MB_cfg_v2_Step2MVA_eventplaneMBOnly_D0SS.py"
config.JobType.numCores = 1
config.JobType.maxMemoryMB = 3000
config.JobType.maxJobRuntimeMin = 2750
config.JobType.outputFiles = ["dstar_delta_mass_hist_step2_fiducial_mvacutm1_d0ss.root"]
