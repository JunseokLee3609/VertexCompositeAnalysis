...
# produce D0 trees
process.load("VertexCompositeAnalysis.VertexCompositeAnalyzer.dStaranalyzer_tree_onnxdebug_cfi")
...
process.dStarana_onnxdebug.CompositeCollection = cms.untracked.InputTag("generalDStarCandidatesNew:DStar")
process.dStarana_onnxdebug.VertexCollection = cms.untracked.InputTag("offlinePrimaryVertices")
process.dStarana_onnxdebug.onnxModelFileName = process.generalD0CandidatesNew.onnxModelFileName
process.dStarana_onnxdebug.input_names = process.generalD0CandidatesNew.input_names
process.dStarana_onnxdebug.output_names = process.generalD0CandidatesNew.output_names
process.dStarana_onnxdebug.doOnnxDebug = cms.untracked.bool(True)
process.dStarana_onnxdebug.onnxPrintThreshold = cms.untracked.double(1e-3)

process.dStarAna_step = cms.Path(
    process.generalD0CandidatesNew *
    process.generalDStarCandidatesNew *
    process.dStarana_onnxdebug
)
