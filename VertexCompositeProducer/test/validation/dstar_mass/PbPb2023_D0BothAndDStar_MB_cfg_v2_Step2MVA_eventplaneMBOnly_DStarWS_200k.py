...
_cfg = os.path.join(
    ...
    "test",
    "validation/dstar_mass/PbPb2023_D0BothAndDStar_MB_cfg_v2_Step2MVA_eventplaneMBOnly_DStarWS.py",
)
...
process.TFileService.fileName = cms.string(
    "VertexCompositeAnalysis/VertexCompositeProducer/test/dstar_delta_mass_hist_step2_fiducial_mvacutm1_dstarws_200k.root"
)
