...
#    fileNames = cms.untracked.vstring("/store/user/junseok/Genproduction/RECO_MINIAOD_DStarKpipiPU_CMSSW_13_2_10_241026_v1/DStarKpipiPU/crab_RECO_MINIAOD_DStarKpipiPU_CMSSW_13_2_10_241026_v1/241026_084606/0000/step4_1.root"),
   ...
   fileNames = cms.untracked.vstring(
       '/store/mc/HINPbPbSpring23MiniAOD/promptD0ToKPi_PT-1_TuneCP5_5p36TeV_pythia8-evtgen/MINIAODSIM/132X_mcRun3_2023_realistic_HI_v9-v2/2560000/079b7bf2-921d-4fb9-8890-5fed918bc7d1.root',
       '/store/mc/HINPbPbSpring23MiniAOD/promptD0ToKPi_PT-1_TuneCP5_5p36TeV_pythia8-evtgen/MINIAODSIM/132X_mcRun3_2023_realistic_HI_v9-v2/2560000/073a4e72-8032-4fca-9531-6ab49903449d.root',
...
process.generalD0CandidatesNew.mvaCut = cms.double(0.7)
...
process.generalD0CandidatesNew.onnxModelFileName = cms.string("XGBoost_Model_0514_0_OnlyPrompt.onnx")
...
#process.generalD0CandidatesNew.mPiKCutMax = cms.double(2.00)
process.generalD0CandidatesNewWrongSign = process.generalD0CandidatesNew.clone(isWrongSign = cms.bool(True))
process.generalDStarCandidatesNewWrongSign = process.generalDStarCandidatesNew.clone(isWrongSign = cms.bool(True))
#
#process.load("VertexCompositeAnalysis.VertexCompositeProducer.generalDStarCandidates_cff")
#process.generalDStarCandidatesNew = process.generalDStarCandidates.clone()
##process.generalDStarCandidatesNew.trkPtSumCut = cms.double(0.0)
...
process.TFileService = cms.Service("TFileService",
    fileName =
    cms.string('d0ana_tree_step2MVA_mc.root')
    )
...
process.d0ana_mc = process.d0ana_mc.clone()
process.d0ana_mc.CompositeCollection = cms.untracked.InputTag("generalD0CandidatesNew:D0")
# process.d0ana_mc.VertexCompositeCollection = cms.untracked.InputTag("generalD0CandidatesNew:D0")
process.d0anaWrongSign_mc = process.d0ana_mc.clone()
process.d0anaWrongSign_mc.CompositeCollection = cms.untracked.InputTag("generalD0CandidatesNewWrongSign:D0")
process.d0anaWrongSign_mc.useAnyMVA = cms.bool(False)
...
process.dStaranaWrongSign_mc = process.dStarana_mc.clone()
process.dStaranaWrongSign_mc.CompositeCollection =cms.untracked.InputTag("generalDStarCandidatesNewWrongSign:DStar")

process.generalDStarCandidatesNew.d0Collection = cms.InputTag("generalD0CandidatesNew:D0")
process.generalDStarCandidatesNewWrongSign.d0Collection = cms.InputTag("generalD0CandidatesNewWrongSign:D0")


# process.d0ana_mc.MVACollection = cms.InputTag("generalD0CandidatesNew:MVAValuesNewD0")
#process.d0ana_mc.DCAValCollection = cms.InputTag("generalD0CandidatesNew:DCAValuesNewD0")
#process.d0ana_mc.DCAErrCollection = cms.InputTag("generalD0CandidatesNew:DCAErrorsNewD0")


process.dStarAna_step = cms.Path( process.eventFilter_HM * process.generalD0CandidatesNew* process.generalDStarCandidatesNew * process.d0ana_mc *process.dStarana_mc)
process.dStarAnaWrongSign_step = cms.Path( process.eventFilter_HM * process.generalD0CandidatesNewWrongSign* process.generalDStarCandidatesNewWrongSign*process.d0anaWrongSign_mc  *process.dStaranaWrongSign_mc)
#process.dStarAna_step = cms.Path( process.eventFilter_HM * process.generalD0CandidatesNew* process.d0ana_mc)
#*process.eventplane)
...
process.schedule = cms.Schedule(
    ...
    process.dStarAnaWrongSign_step,
   process.pevt,
)
