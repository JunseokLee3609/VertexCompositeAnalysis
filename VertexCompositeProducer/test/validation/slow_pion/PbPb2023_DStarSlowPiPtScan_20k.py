...
process.TFileService.fileName = cms.string(
    "VertexCompositeAnalysis/VertexCompositeProducer/test/dstar_slowpi_ptscan_20k.root"
)

process.MessageLogger.cerr.PAT6GenMatchTail = cms.untracked.PSet(
    limit=cms.untracked.int32(-1)
)
process.MessageLogger.cerr.DStarFitterDebug = cms.untracked.PSet(
    limit=cms.untracked.int32(-1)
)
process.generalDStarCandidatesNew.debugSlowPionPtScan = cms.bool(True)
